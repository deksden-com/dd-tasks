...
description: 'Canonical machine-readable SPC-004 and SPC-005 contracts.'
...
related_files:
  ...
  - ../common/flow-runs.md
tags: [schemas, dd-flow, spc-004, spc-005, plan]
---
...
|---|---|---|
| `dd-flow/flow-contract@5` | `../flow-contract.json` | canonical contract |
...
| `dd-flow/stage-prompt@1` | `stage-prompt.schema.json` | generated prompt |
| `dd-flow/stage-start-response@1` | `stage-start-response.schema.json` | start response |
...
- `stage-prompt.md` has exactly seven ordered sections.
