---
file: '.memory-bank/epics/EP-001-task-management/index.md'
description: 'Value area for workspace-scoped project and task management.'
purpose: 'Groups independently deliverable user-visible task-management capabilities.'
version: '0.1.0'
date: '2026-08-15'
status: 'ACTIVE'
